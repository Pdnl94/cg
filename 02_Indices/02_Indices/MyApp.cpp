...
bool CMyApp::Init()
{
	...
	{ 
		//          x,  y, z             R, G, B
		{glm::vec3(-1, -1, 1), glm::vec3(1, 0, 0)},//0
		{glm::vec3( 1, -1, 1), glm::vec3(0, 1, 0)},//1
		{glm::vec3(-1,  1, 1), glm::vec3(0, 0, 1)},//2
		{glm::vec3( 1,  1, 1), glm::vec3(1, 1, 1)},//3

		{glm::vec3(-1, -1, -1), glm::vec3(1, 0, 0)},//4
		{glm::vec3(1, -1, -1), glm::vec3(0, 1, 0)},//5
...
void CMyApp::Render()
{
	...
	*/
	...
	m_matWorld = glm::rotate<float>(t, glm::vec3(1, 1, 0));
